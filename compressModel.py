...
kerasModel = tf.keras.models.load_model(r"C:\Users\gener\OneDrive\Desktop\fruits360.h5")       # Put in model path here
converter = tf.lite.TFLiteConverter.from_keras_model(kerasModel)
tfliteModel = converter.convert()
open(r"C:\Users\gener\OneDrive\Documents\cv-food-app\fruits360LiteModel.tflite", "wb").write(tfliteModel)
